...
description: "Review and improve CLAUDE.md or AGENTS.md from recent Claude/Codex history. Triggers: audit agent instructions, review AGENTS.md, improve CLAUDE.md, learn from past sessions."
---
