...
2. Update from git and rebuild when code may be stale; update the global `clawdis` install if the repo changed; run `pnpm clawdis doctor` after pulling latest to migrate config.
