...
```bash
/Users/ossianhempel/Developer/agent-scripts/skills/autoreview/scripts/autoreview --mode commit --commit HEAD
```
...
```bash
/Users/ossianhempel/Developer/agent-scripts/skills/autoreview/scripts/autoreview --help
```
