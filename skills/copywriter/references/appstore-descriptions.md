...
| Field            | Limit  | Purpose                                          |
|------------------|--------|--------------------------------------------------|
| App Name         | 30     | Brand. Discoverability. First impression.        |
| Subtitle         | 30     | The promise. One concrete outcome.               |
| Promotional Text | 170    | Updateable without review. Hook / news / urgency.|
| Description      | 4000   | The full pitch. Most users only read the first 2–3 lines. |
| What's New       | 4000   | Update notes. Lead with the change users care about. |
| Keywords         | 100    | Comma-separated, no spaces. Search optimization. |

## Before You Write (info gathering)

If you don't already have this context, ask before drafting. Don't guess.
...
**Features**
- Top 3–5 features, in priority order.
- What does this app do that the obvious competitor doesn't?
...
**Tone**
- Direct and dry? Playful? Technical? Reverent?
- Are there brand voice keywords or a tone-of-voice doc?
- What's the language? (Most of Ossian's apps default to Swedish.)
...
- One outcome, in user language. Treat it like a screenshot headline.
- Bad: "Workout tracking made easy."
- Good: "Never forget what you lifted."
...
Most users will only read the first 2–3 lines before deciding to expand. Front-
load the value.
...
[Key features as bullets, each one outcome-first]
...
NEW
• [Feature in outcome language]

IMPROVED
• [What's better, in user terms]
...
Pick the angle that fits the product. All of these beat "Welcome to..."

**Problem-first**
> Tired of losing track of what you lifted last week? GainsLog turns every set
> into a record you can actually use.

**Outcome-first**
> Log a set in two taps. See your progress in one screen. That's it.

**Curiosity-first**
> What if your workout log actually told you when to add weight?

**Specificity-first**
> Built for one job: making sure you never repeat last week's workout by
> accident.
...
### Scaffold: utility / tracker / tool

```
[Hook: one outcome, one line. No warm-up.]

[2–3 sentences naming the user, the friction they have today, and what
changes when they use this. Concrete language.]
...
### Scaffold: creative / generative / expressive
...
• [Where the work goes when it's done]
• [Community / export / publishing if applicable]

[1 paragraph: who's already using it for what. Real names, real use cases if
you have them.]
...
### Scaffold: What's New (per release)

```
Version X.X

[One line: the change users actually care about, in their words.]

NEW
• [Feature, in outcome language]

IMPROVED
• [What's better now, in user terms]
...
- [ ] Subtitle is one outcome in 30 chars
- [ ] First 2 lines of description sell on their own
- [ ] No "Welcome to..." / "Introducing..." / "powerful" / "seamless"
