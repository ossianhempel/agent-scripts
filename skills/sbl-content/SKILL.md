...
### Punctuation
- **NEVER use em-dashes** (the long dash character). Not in captions, not in
  on-screen text, not anywhere. Use a regular hyphen (-) or restructure the
  sentence instead. This is a hard rule with zero exceptions.
