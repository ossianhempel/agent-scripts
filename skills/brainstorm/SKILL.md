---
name: brainstorm
description: Explore a raw, unformed idea through structured dialogue and shape it into a clear WHAT — before any plan exists. Pressure-tests whether and what is worth building (evidence, counterfactual, minimal version), proposes a few concrete approaches, and writes a requirements doc to docs/brainstorms/. Use when the user has a hunch they haven't fleshed out, says "I have an idea", "help me think through", "brainstorm this", "explore this", "I'm not sure what I want yet", or wants to figure out if something's worth building. NOT for stress-testing an existing plan — that's grill-me.
---
