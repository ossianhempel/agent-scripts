...
description: >-
  Apply psychological principles, mental models, and behavioral science to
  marketing challenges. Use when the user mentions psychology, mental models,
  cognitive bias, persuasion, behavioral science, why people buy,
  decision-making, or consumer behavior. Covers 70+ models for conversion
  optimization, pricing, copy, onboarding, growth, and retention.
---
